...
public class MealsUtil {
    ...
    public static final List<Meal> meals = Arrays.asList(
            ...
            new Meal(LocalDateTime.of(2022, Month.JANUARY, 30, 10, 0), "Breakfast", 500, 2),
            new Meal(LocalDateTime.of(2022, Month.JANUARY, 30, 13, 0), "Dinner", 1000, 2),
            new Meal(LocalDateTime.of(2022, Month.JANUARY, 30, 20, 0), "Lunch", 500, 2),
            new Meal(LocalDateTime.of(2022, Month.JANUARY, 31, 0, 0), "Limit food", 100, 2),
            new Meal(LocalDateTime.of(2022, Month.JANUARY, 31, 10, 0), "Breakfast", 1000, 2),
            new Meal(LocalDateTime.of(2022, Month.JANUARY, 31, 13, 0), "Dinner", 500, 2),
            new Meal(LocalDateTime.of(2022, Month.JANUARY, 31, 20, 0), "Lunch", 410, 2)
    );
